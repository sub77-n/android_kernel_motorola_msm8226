...
ifeq ($(filter-out falcon amami aries castor castor_windy eagle flamingo honami ivy karin karin_windy leo satsuki scorpion scorpion_windy seagull sirius sumire suzu suzuran tianchi tianchi_dsds togari tulip,$(TARGET_DEVICE)),)
...
KERNEL_DTB := $(KERNEL_OUT)/arch/$(KERNEL_ARCH)/boot
